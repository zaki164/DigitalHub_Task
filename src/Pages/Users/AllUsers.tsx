...
const AllUsers = () => {
  ...
  return (
    <motion.section
      ...
      <ActionModal open={openDialog} setOpenDialog={setOpenDialog} {...stateObject} own={t("User")} />
      <TablesHeader name={name} setName={setName} title={t("All users")} link="/add-user" linkTitle={t("Add user")} />
                ...
                <tr key={i} className="mb-2 last-of-type:border-b-0 border-b-2">
                  ...
                  <td>
                    <div className="flex items-center gap-3 md:gap-4">
                      <Link to={`/update-user/${ele?.username}`}
